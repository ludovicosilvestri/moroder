...
<Project Type="Project" LVVersion="12008004">
	...
	<Property Name="varPersistentID:{9D29C9FB-E190-41AA-80A6-ECAD4F4222B3}" Type="Ref">/My Computer/Examples/Data Dashboard for LabVIEW/ALPHALAS CCD S Series Shared Variables.lvlib/CCD Data</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Examples" Type="Folder">
			<Item Name="Data Dashboard for LabVIEW" Type="Folder">
				<Item Name="ALPHALAS CCD S Series Acquisition Loop with Shared Variable for NI Data Dashboard.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/Data Dashboard for LabVIEW/ALPHALAS CCD S Series Acquisition Loop with Shared Variable for NI Data Dashboard.vi"/>
			...
			<Item Name="ALPHALAS CCD S Series Acquisition Loop with Multiple Devices Example.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Acquisition Loop with Multiple Devices Example.vi"/>
			<Item Name="ALPHALAS CCD S Series Acquisition Loop with Native 3D Graph Example.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Acquisition Loop with Native 3D Graph Example.vi"/>
			<Item Name="ALPHALAS CCD S Series Acquisition Loop with Runtime Changeable Params Example.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Acquisition Loop with Runtime Changeable Params Example.vi"/>
			<Item Name="ALPHALAS CCD S Series Acquisition Loop with Save and Load and FWHM Calc.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Acquisition Loop with Save and Load and FWHM Calc.vi"/>
			<Item Name="ALPHALAS CCD S Series Data Streaming to File.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Data Streaming to File.vi"/>
			<Item Name="ALPHALAS CCD S Series Device Information.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Device Information.vi"/>
			<Item Name="ALPHALAS CCD S Series Gaussian Fit Loop.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Gaussian Fit Loop.vi"/>
			<Item Name="ALPHALAS CCD S Series Single Acquisition Example.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Single Acquisition Example.vi"/>
			<Item Name="ALPHALAS CCD S Series Single Acquisition to File Example.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Single Acquisition to File Example.vi"/>
			<Item Name="ALPHALAS CCD S Series Speed Test.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series Speed Test.vi"/>
			<Item Name="ALPHALAS CCD S Series View Data from File in 3D Graph All Frames WHITE BG.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series View Data from File in 3D Graph All Frames WHITE BG.vi"/>
			<Item Name="ALPHALAS CCD S Series View Data from File in 3D Graph All Frames.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series View Data from File in 3D Graph All Frames.vi"/>
			<Item Name="ALPHALAS CCD S Series View Data from File in 3D Graph Some Frames.vi" Type="VI" URL="/&lt;instrlib&gt;/ALPHALAS CCD S Series/Examples/ALPHALAS CCD S Series View Data from File in 3D Graph Some Frames.vi"/>
